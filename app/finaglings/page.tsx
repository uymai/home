...
export default function FinaglingsPage() {
  ...
  const mathProjects: Project[] = [
    ...
    {
      title: "NP-Complete",
      description: "What is P vs NP? Some of the hardest problems in computer science, explained for kids, with a backpack-packing game.",
    ...
    },
    {
      ...
      description: "Watch Bubble, Insertion, Quick, Merge, Heap, and Tim Sort put a list in order, step by step, with Python code and easy explanations.",
